                ...
                SettingsSectionCard(
                    ...
                    VStack(spacing: 0) {
                        LinkRow(
                            icon: "globe",
                            title: "Web Sitesi",
                            value: "fourkampus.com.tr",
                            url: "https://fourkampus.com.tr",
                            color: Color(hex: "6366f1")
                        )
                        Divider().padding(.vertical, 12)
                        LinkRow(
                            icon: "envelope.fill",
                            title: "E-posta",
                            value: "info@fourkampus.com.tr",
                            url: "mailto:info@fourkampus.com.tr",
                            color: Color(hex: "6366f1")
                        )
                    }
                    .padding(.vertical, 4)
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    SupportOptionCard(
                        ...
                        email: "destek@fourkampus.com.tr",
                        color: Color(hex: "6366f1")
                    )
                    ...
                    SupportOptionCard(
                        ...
                        website: "https://fourkampus.com.tr",
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        FAQCard(
                            ...
                            answer: "İlgilendiğiniz topluluğun sayfasına giderek 'Katıl' butonuna tıklamanız yeterlidir. Bazı topluluklar yönetici onayı gerektirebilir."
                        )
                        
                        FAQCard(
                            question: "Etkinliklere katılım ücretli mi?",
                            answer: "Etkinliklerin çoğu ücretsizdir ancak bazı özel etkinlikler biletli olabilir. Her etkinliğin detay sayfasında ücret bilgisi yer almaktadır."
                        )
                        
                        FAQCard(
                            question: "Şifremi unuttum, ne yapmalıyım?",
                            answer: "Giriş ekranındaki 'Şifremi Unuttum' bağlantısını kullanarak e-posta adresinize sıfırlama bağlantısı gönderebilirsiniz."
                        )
                        
                        FAQCard(
                            question: "Topluluk oluşturmak istiyorum.",
