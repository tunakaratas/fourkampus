...
try {
    ...
    // Domain kısıtlaması kaldırıldı - tüm geçerli email adresleri kabul edilir (gmail.com, yahoo.com, vb.)
    ...
    try {
        // ═══════════════════════════════════════════════════════════════════
        // SMTP AYARLARI - TEK KAYNAK: config/credentials.php
        // ═══════════════════════════════════════════════════════════════════
        
        // Communication modülünü yükle (send_smtp_mail ve get_smtp_credential için)
        ...
        // Credential'ları merkezi config'den al
        $smtp_host = get_smtp_credential('host', '');
        ...
        $smtp_from_email = get_smtp_credential('from_email', '');
        $smtp_from_name = get_smtp_credential('from_name', 'UniPanel');
        
        $subject = 'UniPanel E-posta Doğrulama Kodu';
        $message = "Merhaba,\n\nUniPanel'e kayıt olmak için e-posta doğrulama kodunuz:\n\n{$code}\n\nBu kod 10 dakika geçerlidir.\n\nEğer bu işlemi siz yapmadıysanız, bu e-postayı görmezden gelebilirsiniz.\n\nUniPanel Ekibi";
